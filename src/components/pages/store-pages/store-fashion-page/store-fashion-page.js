...
import './store-fashion-page.css';

const StoreFashionPage = () => {

  const title = 'Official Store';

  return (
    <div className='store-fashion-page'>
...
export default StoreFashionPage;